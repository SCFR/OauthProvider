...
use SCFROAuth2\Storage\JwtBearerInterface;
use SCFROAuth2\Encryption\Jwt;
use SCFROAuth2\Encryption\EncryptionInterface;
...
class JwtBearer implements GrantTypeInterface, ClientAssertionTypeInterface
{
     ...
     *
     * @param SCFROAuth2\Storage\JWTBearerInterface|JwtBearerInterface $storage A valid storage interface that implements storage hooks for the JWT bearer grant type.
     ...
     * @param EncryptionInterface|SCFROAuth2\Encryption\JWT $jwtUtil OPTONAL The class used to decode, encode and verify JWTs.
     * @param array $config
     */
     ...
     *
     * @see SCFROAuth2\GrantType\GrantTypeInterface::getQuerystringIdentifier()
     */
     ...
     *
     * @see SCFROAuth2\GrantType\GrantTypeInterface::getTokenData()
     */
     ...
     *
     * @see SCFROAuth2\GrantType\GrantTypeInterface::createAccessToken()
     */
