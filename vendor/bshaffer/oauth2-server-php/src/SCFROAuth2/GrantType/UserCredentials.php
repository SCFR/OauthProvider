...
use SCFROAuth2\Storage\UserCredentialsInterface;
...
class UserCredentials implements GrantTypeInterface
{
    ...
    /**
     * @param SCFROAuth2\Storage\UserCredentialsInterface $storage REQUIRED Storage class for retrieving user credentials information
     */
