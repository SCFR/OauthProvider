 ...
 * <code>
 *  $storage = new SCFROAuth2\Storage\Dynamodb(array("key" => "YOURKEY", "secret" => "YOURSECRET", "region" => "YOURREGION"));
 * </code>
 *
 * Table :
    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    public function __construct($connection, $config = array())
    {
        if (!($connection instanceof DynamoDbClient)) {
            if (!is_array($connection)) {
                throw new \InvalidArgumentException('First argument to SCFROAuth2\Storage\Dynamodb must be an instance a configuration array containt key, secret, region');
            }
    ...
    /* SCFROAuth2\Storage\ClientCredentialsInterface */
    ...
    /* SCFROAuth2\Storage\ClientInterface */
    ...
    /* SCFROAuth2\Storage\AccessTokenInterface */
    ...
    /* SCFROAuth2\Storage\AuthorizationCodeInterface */
    ...
    /* SCFROAuth2\Storage\UserCredentialsInterface */
    ...
    /* SCFROAuth2\Storage\RefreshTokenInterface */
