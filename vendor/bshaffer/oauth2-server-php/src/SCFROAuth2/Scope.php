...
use SCFROAuth2\Storage\ScopeInterface as ScopeStorageInterface;

/**
* @see SCFROAuth2\ScopeInterface
*/
class Scope implements ScopeInterface
{
    ...
    /**
     * @param mixed @storage
     * Either an array of supported scopes, or an instance of SCFROAuth2\Storage\ScopeInterface
     */
    public function __construct($storage = null)
    {
        ...
        if (!$storage instanceof ScopeStorageInterface) {
            throw new \InvalidArgumentException("Argument 1 to SCFROAuth2\Scope must be null, an array, or instance of SCFROAuth2\Storage\ScopeInterface");
        }
