    ...
    public function __construct($connection, $config = array())
    {
        if ($connection instanceof \Couchbase) {
            ...
            if (!is_array($connection) || !is_array($connection['servers'])) {
                throw new \InvalidArgumentException('First argument to SCFROAuth2\Storage\CouchbaseDB must be an instance of Couchbase or a configuration array containing a server array');
            }
