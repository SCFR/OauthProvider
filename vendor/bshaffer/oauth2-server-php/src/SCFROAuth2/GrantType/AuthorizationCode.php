...
use SCFROAuth2\Storage\AuthorizationCodeInterface;
...
class AuthorizationCode implements GrantTypeInterface
{
    ...
    /**
     * @param \SCFROAuth2\Storage\AuthorizationCodeInterface $storage REQUIRED Storage class for retrieving authorization code information
     */
