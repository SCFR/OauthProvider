...
use SCFROAuth2\Storage\AccessTokenInterface as AccessTokenStorageInterface;
use SCFROAuth2\Storage\RefreshTokenInterface;
...
class AccessToken implements AccessTokenInterface
{
    ...
    /**
     * @param SCFROAuth2\Storage\AccessTokenInterface  $tokenStorage   REQUIRED Storage class for saving access token information
     * @param SCFROAuth2\Storage\RefreshTokenInterface $refreshStorage OPTIONAL Storage class for saving refresh token information
    ...
    public function createAccessToken($client_id, $user_id, $scope = null, $includeRefreshToken = true)
    {
         ...
         *
         * Refresh Tokens are considered supported if an instance of SCFROAuth2\Storage\RefreshTokenInterface
