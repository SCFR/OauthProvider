...
/**
 * @see SCFROAuth2\Controller\AuthorizeControllerInterface
 */
class AuthorizeController implements AuthorizeControllerInterface
{
    ...
    /**
     * @param SCFROAuth2\Storage\ClientInterface $clientStorage REQUIRED Instance of SCFROAuth2\Storage\ClientInterface to retrieve client information
     * @param array                          $responseTypes OPTIONAL Array of SCFROAuth2\ResponseType\ResponseTypeInterface objects.  Valid array
     ...
     *                                                      );
     *                                                      </code>
     * @param SCFROAuth2\ScopeInterface          $scopeUtil     OPTIONAL Instance of SCFROAuth2\ScopeInterface to validate the requested scope
     */
