...
use SCFROAuth2\Storage\ClientCredentialsInterface;
...
class HttpBasic implements ClientAssertionTypeInterface
{
    ...
    /**
     * @param SCFROAuth2\Storage\ClientCredentialsInterface $clientStorage REQUIRED Storage class for retrieving client credentials information
