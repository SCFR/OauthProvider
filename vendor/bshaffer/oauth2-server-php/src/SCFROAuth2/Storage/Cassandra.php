 ...
 * <code>
 *  $storage = new SCFROAuth2\Storage\Cassandra($cassandra);
    ...
    public function __construct($connection = array(), array $config = array())
    {
        if ($connection instanceof ConnectionPool) {
            ...
            if (!is_array($connection)) {
                throw new \InvalidArgumentException('First argument to SCFROAuth2\Storage\Cassandra must be an instance of phpcassa\Connection\ConnectionPool or a configuration array');
            }
