...
use SCFROAuth2\ResponseType\AuthorizationCode as BaseAuthorizationCode;
use SCFROAuth2\OpenID\Storage\AuthorizationCodeInterface as AuthorizationCodeStorageInterface;
