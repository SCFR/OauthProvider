...
use SCFROAuth2\Storage\ClientInterface;
use SCFROAuth2\RequestInterface;
use SCFROAuth2\ResponseInterface;

/**
 * @see \SCFROAuth2\Controller\TokenControllerInterface
 */
class TokenController implements TokenControllerInterface
{
        ...
        if (is_null($clientAssertionType)) {
            foreach ($grantTypes as $grantType) {
                if (!$grantType instanceof ClientAssertionTypeInterface) {
                    throw new \InvalidArgumentException('You must supply an instance of SCFROAuth2\ClientAssertionType\ClientAssertionTypeInterface or only use grant types which implement SCFROAuth2\ClientAssertionType\ClientAssertionTypeInterface');
                }
            }
        }
    ...
    public function grantAccessToken(RequestInterface $request, ResponseInterface $response)
    {
         ...
         *
         * @see SCFROAuth2\GrantType\JWTBearer
         * @see SCFROAuth2\GrantType\ClientCredentials
         */
        if (!$grantType instanceof ClientAssertionTypeInterface) {
